					...
					<tbody>
						...
						<tr>
							...
							<td width="1%" style="white-space: nowrap">
								<div class="btn-group">
									...
									<ul class="dropdown-menu">
										<li><a href="{{ route('pimpinan.daftar_hasil_terapi', ['terapi_anak_id' => $terapi_anak->id]) }}">Lihat</a></li>
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="{{ route('pimpinan.daftar_hasil_evaluasi', ['terapi_anak_id' => $terapi_anak->id]) }}">Lihat</a></li>
